...
const DiamondDiagram = ({ birthday }: IDiamondDiagram) => {
  ...
  // TODO: Move to a central function. Duplicated with MainNavbar
  ...
  const prettyDate: string = birthday.toLocaleDateString(['es-mx', 'en-us'], formatOptions)
  ...
  return (
	...
	l-14.43,32.54l-43.86-23.75L265.1,197.96z M336.19,355.64L380,248.73l43-22.33L336.19,355.64z"
          />
          <text transform="matrix(1 0 0 1 298.3 240.3379)" className="diamond-st2 st3">
            FE
          </text>
          <g>
            <text transform="matrix(1 0 0 1 298.3002 202.3315)" className="diamond-st2 st3">
              FR
            </text>
          </g>
          <text transform="matrix(1 0 0 1 324.8513 276.8158)" className="diamond-st2 st3">
            R
          </text>
          <text transform="matrix(1 0 0 1 366.8328 355.3526)" className="diamond-st2 st3">
            RC
          </text>
          ...
          <text transform="matrix(1 0 0 1 241.6145 355.7993)" className="diamond-st2 st5">
